        ...
        <div class="modal-content" id="registermodal">
            ...
            <div class="modal-body">
                ...
                <div class="social-login mb-3">
                    <ul>
                        <li class="left"><a href="#" class="theme-cl"><?php _e('Forget password?', 'jve' ) ?></a></li>
                    </ul>
                </div>
                
                <div class="text-center">
                    <p class="mt-2"><?php _e('Don\'t you have an account?', 'jve' ) ?><a href="register.html" class="link"> <?php _e('Make an account!', 'jve' ) ?> </a></p>
                </div>
            </div>
        </div>
    </div>
