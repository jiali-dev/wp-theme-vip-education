        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="education_block_grid">
                    ...
                    <div class="education_block_thumb">
                        <a href="course-detail.html"><img src="<?php echo VIP_EDUCATION_IMAGES_URI . '/course-1.jpg' ?>" class="img-fluid" alt=""></a>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="education_block_grid">
                    ...
                    <div class="education_block_thumb">
                        <a href="course-detail.html"><img src="<?php echo VIP_EDUCATION_IMAGES_URI . '/course-2.jpg' ?>" class="img-fluid" alt=""></a>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="education_block_grid">
                    ...
                    <div class="education_block_thumb">
                        <a href="course-detail.html"><img src="<?php echo VIP_EDUCATION_IMAGES_URI . '/course-3.jpg' ?>" class="img-fluid" alt=""></a>
                    <div class="topic_level bg-warning text-white">جاوااسکریپت</div>
                    </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="education_block_grid">
                    ...
                    <div class="education_block_thumb">
                        <a href="course-detail.html"><img src="<?php echo VIP_EDUCATION_IMAGES_URI . '/course-4.jpg' ?>" class="img-fluid" alt=""></a>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="education_block_grid">
                    ...
                    <div class="education_block_thumb">
                        <a href="course-detail.html"><img src="<?php echo VIP_EDUCATION_IMAGES_URI . '/course-5.jpg' ?>" class="img-fluid" alt=""></a>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="education_block_grid">
                    ...
                    <div class="education_block_thumb">
                        <a href="course-detail.html"><img src="<?php echo VIP_EDUCATION_IMAGES_URI . '/course-6.jpg' ?>" class="img-fluid" alt=""></a>
